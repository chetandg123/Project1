...
class Facebook(unittest.TestCase):
    ...
    def test_login(self):
        ...
        self.driver.get_screenshot_as_file("/home/chetan/PycharmProjects/Project1/TestReports/fb.png")
    ...
    def test_asser(self):
        print(self.driver.title)
        self.driver.get_screenshot_as_file("/home/chetan/PycharmProjects/Project1/TestReports/fbhome.png")
